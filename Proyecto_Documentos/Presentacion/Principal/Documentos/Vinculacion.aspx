<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Principal/Inicio/Administracion.Master" AutoEventWireup="true" CodeBehind="Vinculacion.aspx.cs" Inherits="Proyecto_Documentos.Presentacion.Principal.Documentos.Vinculacion" Culture="auto" UICulture="auto" %>
    ...
    <asp:Table runat="server" Height="16px" Width="913px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell Width="60%" HorizontalAlign="Center">
                <asp:Label runat="server" Text="Aprobación Carta de Compromiso" Font-Size="X-Large"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="20%"></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
     ...
     <asp:Table runat="server" Width="100%">
        ...
        <asp:Table ID="Table1" runat="server" Height="261px" Width="921px" style="margin-bottom: 0px">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:DropDownList ID="ddlPresidentesVinculacion" runat="server"></asp:DropDownList>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Right">
