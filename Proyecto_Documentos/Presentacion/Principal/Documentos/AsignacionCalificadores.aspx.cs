...
{
    public partial class AsignacionCalificadores : System.Web.UI.Page
    {
        ...
        private void GenerarWord()
        {
            ...
            DocX document = DocX.Load(Server.MapPath("~/Plantilla/DESIGNAR_CALIFICADORES_DEL_TRABAJO_DE_TITULACIÓN.docx"));
            ...
            document.Bookmarks["FechaSolicitud"].SetText(txtFechaMemorando.Text);
            ...
            document.Bookmarks["Estudiante2"].SetText(txtApellidos.Text + " " + TxtNombres.Text);
            document.Bookmarks["EstudianteCarrera2"].SetText(txtCarreraEstudiante.Text);
            document.Bookmarks["Tema"].SetText(txtTema.Text);
            ...
            cuerpo = cuerpo + document.Bookmarks["Cuerpo8"].Paragraph.Text + "\n\n";
        ...
        private bool CamposLlenos()
        {
            if (txtFecha.Text.Equals("") || txtNResolucion.Text.Length != 4 ||
                txtFechaSesion.Text.Equals("") || txtFechaMemorando.Text.Equals("") || txtTema.Equals("") ||
