<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Principal/Inicio/Administracion.Master" AutoEventWireup="true" CodeBehind="AprobacionReingreso.aspx.cs" Inherits="Proyecto_Documentos.Presentacion.Principal.Documentos.AprobacionReingreso" %>
    ...
    <asp:Table runat="server" Height="16px" Width="913px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell Width="60%" HorizontalAlign="Center">
                <asp:Label runat="server" Text="Aprobacion Reingreso" Font-Size="X-Large"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="20%"></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
