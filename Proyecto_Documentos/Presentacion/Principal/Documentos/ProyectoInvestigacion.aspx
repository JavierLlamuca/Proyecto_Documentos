<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Principal/Inicio/Administracion.Master" AutoEventWireup="true" CodeBehind="ProyectoInvestigacion.aspx.cs" Inherits="Proyecto_Documentos.Presentacion.Principal.Documentos.ProyectoInvestigacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell Width="60%" HorizontalAlign="Center">
                <asp:Label runat="server" Text="Modalidad Proyecto de Investigación" Font-Size="X-Large"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="20%"></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        ...
        <asp:Table ID="Table1" runat="server" Height="261px" Width="921px" style="margin-bottom: 0px">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right" Width="10%">
                    <asp:Label  runat="server" Text="P. Titulación: "></asp:Label>
                </asp:TableCell>
                <asp:TableCell Width="15%">
                    <asp:TextBox ID="txtDocente" runat="server" AutoCompleteType="Disabled" Enabled="false" onkeypress="ValidaSoloNumeros()" placeholder="0000"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Right" Width="10%">
                ...
                <asp:TableCell Width="15%">
                    <asp:TextBox ID="txtNMemorando" runat="server" Width="20%" MaxLength="4" AutoCompleteType="Disabled"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <%--Segunda Fila--%>
            <asp:TableRow>
