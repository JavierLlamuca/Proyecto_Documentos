...
{
    public partial class ReconocimientoCultura : System.Web.UI.Page
    {
        ...
        private bool CamposLlenos()
        {
            if (txtFecha.Text.Equals("") || txtNResolucion.Text.Length != 4 ||
                txtNMemorando.Text.Length != 4 || txtFacultadAprobo.Text.Equals("") ||
                txtCarreraAprobo.Text.Equals("") || txtFechaSesion.Text.Equals("") || txtFechaMemorando.Text.Equals("") || txtCedula.Text.Equals("") ||
        ...
        private void GenerarWord()
        {
            ...
            DocX document = DocX.Load(Server.MapPath("~/Plantilla/APROBACION_RECONOCIMIENTO_CULTURA FISICA.docx"));
            ...
            document.Bookmarks["Carreras"].SetText(txtCarreraAprobo.Text);
            ...
            document.Bookmarks["CarrerasM1"].SetText(txtCarreraAprobo.Text.ToUpper());
            document.Bookmarks["FacultadM"].SetText(txtFacultadAprobo.Text.ToUpper());
            document.Bookmarks["CarreraEstudianteM2"].SetText(txtCarreraEstudiante.Text.ToUpper());
            ...
            document.Bookmarks["CarrerasM"].SetText(txtCarreraAprobo.Text.ToUpper());


            document.Bookmarks["Miembro"].SetText(txtAtentamente.Text);
            document.Bookmarks["MiembroCargo"].SetText(txtCargoMiembro.Text + "\n");
            document.Bookmarks["PresidenteCAF2"].SetText(txtPresidente.Text);
            //Llevar el cuerpo
