...
namespace Proyecto_Documentos.Presentacion.Principal.Documentos
{
    public partial class TerceraMatricula : System.Web.UI.Page
    {
        ...
        private void GenerarWord()
        {
            ...
            DocX document = DocX.Load(Server.MapPath("~/Plantilla/AUTORIZACION_TERCERA_MATRÍCULA.docx"));
            ...
            document.Bookmarks["PresidenteConsejoAcademico"].SetText(txtPresidente.Text);
            ...
            document.Bookmarks["Asignaturas"].SetText(txtAsignaturas.Text);
            document.Bookmarks["Carrera"].SetText(txtCarreraEstudiante.Text);
            document.Bookmarks["PeriodoAcademico"].SetText(txtPeriodo.Text);
            ...
            document.Bookmarks["CarreraM"].SetText(txtCarreraEstudiante.Text.ToUpper());
            document.Bookmarks["AsignaturasM"].SetText(txtCarreraEstudiante.Text.ToUpper());
            document.Bookmarks["PeriodoAcademicoM"].SetText(txtPeriodo.Text.ToUpper());
            document.Bookmarks["CarreraCoordinadorR"].SetText(txtCarreraEstudiante.Text.ToUpper());



            document.Bookmarks["Miembro"].SetText(txtAtentamente.Text);
            document.Bookmarks["CargoMiembro"].SetText(txtCargoMiembro.Text + "\n");
        ...
        private bool CamposLlenos()
        {
            if (txtFecha.Text.Equals("") || txtNResolucion.Text.Length != 4 ||
             txtNMemorando.Text.Length != 4 ||
            txtFechaSesion.Text.Equals("") || txtFechaMemorando.Text.Equals("") || txtCedula.Text.Equals("") ||
