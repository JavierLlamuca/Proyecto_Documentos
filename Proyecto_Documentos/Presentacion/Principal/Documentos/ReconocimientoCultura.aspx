<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Principal/Inicio/Administracion.Master" AutoEventWireup="true" CodeBehind="ReconocimientoCultura.aspx.cs" Inherits="Proyecto_Documentos.Presentacion.Principal.Documentos.ReconocimientoCultura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Table runat="server" Height="16px" Width="913px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell Width="60%" HorizontalAlign="Center">
                <asp:Label runat="server" Text="Reconocimiento Cultura Fisica" Font-Size="X-Large"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="20%"></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
    ...
    <asp:Table runat="server" Width="100%">
        ...
        <asp:Table ID="Table1" runat="server" Height="261px" Width="921px" style="margin-bottom: 0px">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right">
                    <asp:Label runat="server" Text="Aprobo en: "></asp:Label>
                </asp:TableCell>
                <asp:TableCell ColumnSpan="5">
                    <asp:TextBox runat="server" ID="txtCarreraAprobo" Width="90%" placeholder="Carrera donde se aprobo" onkeypress="txNombres()"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right">
                ...
                <asp:TableCell ColumnSpan="5">
                    <asp:TextBox runat="server" ID="txtFacultadAprobo" Width="90%" placeholder="Facultad donde se aprobo"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell ColumnSpan="6"></asp:TableCell>
