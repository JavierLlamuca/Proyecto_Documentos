...
namespace Proyecto_Documentos.Presentacion.Principal.Documentos
{
    public partial class ProrrogaPagada : System.Web.UI.Page
    {
        ...
        private void GenerarWord()
        {
            ...
            DocX document = DocX.Load(Server.MapPath("~/Plantilla/APROBACION_PRORROGA_PAGADA.docx"));
            ...
            document.Bookmarks["Periodo1"].SetText(txtPeriodo2.Text.ToUpper());

            document.Bookmarks["EstudianteM2"].SetText(txtApellidos.Text.ToUpper() + " " + TxtNombres.Text.ToUpper());
            document.Bookmarks["PeriodoDecimo"].SetText(txtPeriodo.Text.ToUpper());

            document.Bookmarks["CarreraEstudianteM"].SetText(txtCarreraEstudiante.Text.ToUpper());
            document.Bookmarks["Tema"].SetText(txtTema.Text.ToUpper());
            document.Bookmarks["Tutor"].SetText(txtTutor.Text.ToUpper());
