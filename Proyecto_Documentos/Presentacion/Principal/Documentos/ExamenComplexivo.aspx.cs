...
namespace Proyecto_Documentos.Presentacion.Principal.Documentos
{
    public partial class ExamenComplexivo : System.Web.UI.Page
    {
        ...
        private void GenerarWord()
        {
            ...
            DocX document = DocX.Load(Server.MapPath("~/Plantilla/APROBACIÓN_MODALIDAD_EXAMEN_COMPLEXIVO.docx"));
            ...
            document.Bookmarks["FehaAcuerdo"].SetText(txtFechaMemorando.Text);
            document.Bookmarks["PresidenteTitulacion2"].SetText(txtPresidente.Text);
            document.Bookmarks["EstudianteM"].SetText(txtApellidos.Text + " " + TxtNombres.Text);
            ...
            document.Bookmarks["CarreraEstudianteM"].SetText(txtCarreraEstudiante.Text);
            document.Bookmarks["EstudianteM3"].SetText(txtApellidos.Text + " " + TxtNombres.Text);
            document.Bookmarks["EstudianteM4"].SetText(txtApellidos.Text + " " + TxtNombres.Text);
