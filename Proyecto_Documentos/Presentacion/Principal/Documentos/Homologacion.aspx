<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Principal/Inicio/Administracion.Master" AutoEventWireup="true" CodeBehind="Homologacion.aspx.cs" Inherits="Proyecto_Documentos.Presentacion.Principal.Documentos.Homologacion" %>
     ...
     <asp:Table runat="server" Height="16px" Width="913px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell Width="60%" HorizontalAlign="Center">
                <asp:Label runat="server" Text="Homologación de Asignaturas" Font-Size="X-Large"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="20%"></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
        ...
        <asp:Table ID="Table1" runat="server" Height="261px" Width="921px" style="margin-bottom: 0px">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Left">
                    <asp:TextBox runat="server" ID="txtCedula" Enabled="false"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
             <asp:TableRow>
