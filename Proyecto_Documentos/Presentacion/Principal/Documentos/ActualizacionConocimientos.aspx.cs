...
namespace Proyecto_Documentos.Presentacion.Principal.Documentos
{
    public partial class ActualizacionConocimientos : System.Web.UI.Page
    {
        ...
        private void GenerarWord()
        {
            ...
            DocX document = DocX.Load(Server.MapPath("~/Plantilla/APROBACIÓN_ACTUALIZACIÓN_DE_CONOCIMIENTOS.docx"));
            ...
            document.Bookmarks["CarreraCoordinadorS"].SetText(txtCarreraEstudiante.Text.ToUpper());
            ...
            document.Bookmarks["PresidenteCAFP"].SetText(txtPresidente.Text);
            //
        ...
        private bool CamposLlenos()
        {
            if (txtFecha.Text.Equals("") || txtNResolucion.Text.Length != 4 ||
             txtNMemorando.Text.Length !=4 || txtPeriodo.Text.Equals("") ||
