<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Principal/Inicio/Administracion.Master" AutoEventWireup="true" CodeBehind="ActualizacionConocimientos.aspx.cs" Inherits="Proyecto_Documentos.Presentacion.Principal.Documentos.ActualizacionConocimientos" %>
     ...
     <asp:Table runat="server" Height="16px" Width="913px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell Width="60%" HorizontalAlign="Center">
                <asp:Label runat="server" Text="Actualización de Conocimientos" Font-Size="X-Large"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="20%"></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
    ...
    <asp:Table runat="server" Width="100%">
        ...
        <asp:Table ID="Table1" runat="server" Height="261px" Width="921px" style="margin-bottom: 0px">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell Width="15%">
                    <asp:TextBox ID="txtNMemorando" runat="server" Width="20%" MaxLength="4" AutoCompleteType="Disabled" onkeypress="ValidaSoloNumeros()" placeholder="000"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Right" Width="10%">
                </asp:TableCell>
                <asp:TableCell Width="15%">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right">
                    <asp:Label runat="server" Text="Periodo Académico: "></asp:Label>
                </asp:TableCell>

                <asp:TableCell ColumnSpan="2">
                    <asp:TextBox runat="server" ID="txtPeriodo" Width="60%"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Right">
