<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Principal/Inicio/Administracion.Master" AutoEventWireup="true" CodeBehind="ProrrogaGratuita.aspx.cs" Inherits="Proyecto_Documentos.Presentacion.Principal.Documentos.ProrrogaGratuita" %>
    ...
    <asp:Table runat="server" Height="16px" Width="913px">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell Width="60%" HorizontalAlign="Center">
                <asp:Label runat="server" Text="Prorroga Gratuita" Font-Size="X-Large"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="20%"></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
    ...
    <hr/>
        ...
        <asp:Table ID="Table1" runat="server" Height="261px" Width="921px" style="margin-bottom: 0px">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Right" Width="10%">
                    <asp:Label runat="server" Text="N° Acuerdo: "></asp:Label>
                </asp:TableCell>
                <asp:TableCell Width="15%">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right" Width="10%">
                    <asp:Label runat="server" Text="Coordinador "></asp:Label>
                </asp:TableCell>
                <asp:TableCell Width="15%">
                    <asp:DropDownList runat="server" ID="ddlCoordinadores" ></asp:DropDownList>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Left" Width="10%" ColumnSpan="4">                  
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell></asp:TableCell>
                <asp:TableCell ColumnSpan="5">
                    <asp:DropDownList runat="server" id="ddlCarrerasCoordinador"></asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
            <%--Segunda Fila--%>
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Right">
                    <asp:Label runat="server">Fecha Acuerdo: </asp:Label>
                </asp:TableCell>
                <asp:TableCell ColumnSpan="2">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="txtPresidente" runat="server" Enabled="false"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Right">                    
                </asp:TableCell>
                <asp:TableCell ColumnSpan="2">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell ColumnSpan="2">
                    <asp:TextBox runat="server" ID="txtPeriodo" Width="90%" placeholder="Periodo del décimo semestre"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell></asp:TableCell>
                <asp:TableCell></asp:TableCell>
                <asp:TableCell></asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right">
                    <asp:Label runat="server" Text="Periodo Actual: "></asp:Label>
                </asp:TableCell>
                <asp:TableCell ColumnSpan="2">
                    <asp:TextBox runat="server" ID="txtPeriodo2" Width="90%" placeholder="Periodo para prorroga"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell></asp:TableCell>
                <asp:TableCell></asp:TableCell>
                <asp:TableCell></asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Right">
                    <asp:Label runat="server" Text="Tutor: "></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:TextBox runat="server" ID="txtTutor"></asp:TextBox>
                </asp:TableCell>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Right">
                    <asp:Label runat="server" Text="CI: "></asp:Label>
                </asp:TableCell>
                <asp:TableCell HorizontalAlign="Left">
                    <asp:TextBox ID="txtCedula" runat="server" AutoCompleteType="Disabled" Enabled="false"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
             <asp:TableRow>
